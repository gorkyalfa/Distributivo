...
export class AsignaturaDocenteComponent implements OnInit {
  ...
  asignarAsignaturaDocente(asignaturaId: number, docenteId: number) {
    const asignatura = this.asignaturas.find((a) => a.id === asignaturaId);
    this.retirarDocenteActual(asignatura);
    this.asignarDocenteNuevo(asignatura, docenteId);
  }

  private asignarDocenteNuevo(asignatura: Asignatura, docenteId: number) {
  ...
  private retirarDocenteActual(asignatura: Asignatura) {
